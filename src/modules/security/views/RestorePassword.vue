        ...
        <Stepper value="1" linear class="basis-[50rem]">
            ...
            <StepPanels>
                <StepPanel v-slot="{ activateCallback }" value="1">
                    <Form class="p-2 w-74">
                        <div class="">
                            <p class="mb-7">{{ t('recover_password.email') }}</p>
                ...
                <StepPanel v-slot="{ activateCallback }" value="2">
                    <Form class="p-2 w-74">
                        <div>
                            <p class="mb-7">{{ t('recover_password.recover_code') }}</p>
                ...
                <StepPanel v-slot="{ activateCallback }" value="3">
                    <Form class="p-2 w-74">
                        <div>
                            <p class="mb-7">{{ t('change_password.new_password') }}</p>
                            <VInput :label="t('auth.password')" name="password" class="auth_input"></VInput>
                            <VInput :label="t('change_password.confirm_password')" name="confirm_password" class="auth_input"></VInput>
                        </div>
                        <div class="flex flex-justify-between">
